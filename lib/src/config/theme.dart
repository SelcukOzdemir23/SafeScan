...
class AppTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: ColorScheme.light(
        ...
        primaryContainer:
            Colors.teal.shade100, // Lighter primary for containers
        onPrimaryContainer: Colors.teal.shade900,
        secondaryContainer:
            Colors.amber.shade100, // Lighter secondary for containers
      ...
      textTheme: _buildTextTheme(
          ThemeData.light().textTheme), // Use base light theme text
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: Colors.teal.shade600, // Text color on button
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: _buildTextTheme(
          ThemeData.dark().textTheme), // Use base dark theme text
      buttonTheme: ButtonThemeData(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
